# HEADER ====================================================================================
# File   : ff_draft_organizer_2013.py
# Author : Jay Oatts
...
# TODO:
# 1. Apply depth chart position (probably requires different website)
# 2. Modify for snake draft
# 3. Add verbosity setting from command line
...
# USER DEFINES ==============================================================================
# Output file
OUT_FILE = "fantasy_football_auction_value_2013.txt"
VERBOSITY = 2
...
KEEPER_MONEY_SPENT = (18+82+73+46+37+13+16+25+58+36+19+112)
...
QB_TOP_RESERVE   = 18 - 1
QB_STARTER       = 12 - 1
QB_ELITE_STARTER = 6 - 1

RB_ROSTER        = 60 - 1
RB_TOP_RESERVE   = 54 - 1
RB_STARTER       = 36 - 1
RB_ELITE_STARTER = 18 - 1

WR_ROSTER        = 60 - 1
WR_TOP_RESERVE   = 54 - 1
WR_STARTER       = 36 - 1
WR_ELITE_STARTER = 18 - 1

TE_ROSTER        = 20 - 1
TE_TOP_RESERVE   = 18 - 1
TE_STARTER       = 12 - 1
TE_ELITE_STARTER = 6 - 1
